...
motor_physical_parameters.maxtorque.value  =   motor_physical_parameters.maxcurrent.value*motor_physical_parameters.torqueconstant.value;
motor_physical_parameters.maxtorque.units  =   '[Nm]';

% Motor software parameters
motor_software_parameters.maxcurrent.value  =   5;
motor_software_parameters.maxcurrent.units  =   '[A]';

motor_software_parameters.maxtorque.value  =   4;
motor_software_parameters.maxtorque.units  =   '[Nm]';
