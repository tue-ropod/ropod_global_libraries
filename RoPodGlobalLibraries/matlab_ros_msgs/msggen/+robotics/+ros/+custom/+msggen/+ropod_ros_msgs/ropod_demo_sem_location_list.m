classdef ropod_demo_sem_location_list < robotics.ros.Message
    %ropod_demo_sem_location_list MATLAB implementation of ropod_ros_msgs/ropod_demo_sem_location_list
    ...
    properties (Constant)
        MessageType = 'ropod_ros_msgs/ropod_demo_sem_location_list' % The ROS message type
    end
    ...
    methods
        function obj = ropod_demo_sem_location_list(msg)
            %ropod_demo_sem_location_list Construct the message object ropod_demo_sem_location_list
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ropod_demo_sem_location_list', 'Header');
        ...
        function set.SemWaypoint(obj, semwaypoint)
            ...
            validateattributes(semwaypoint, {obj.RopodRosMsgsRopodSemWaypointClass}, {'vector'}, 'ropod_demo_sem_location_list', 'SemWaypoint');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.ropod_ros_msgs.ropod_demo_sem_location_list.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.ropod_ros_msgs.ropod_demo_sem_location_list;
            obj.reload(strObj);
        end
    end
end
